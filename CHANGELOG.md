...
- [GC-008](GC-008) customer change model classes
- [GC-009](GC-009) git-cliff script to generate CHANGELOG.md
- [**breaking**] [GC-010](GC-010) customer contact methods

### Fixed

- [GC-011](GC-011) keep a change configuration now supports breaking changes in commits messages
...
- [**breaking**] [GC-007](GC-007) order model classes
...
- [GC-006](GC-006) log4j dependency updated to the last version

OverIT s.p.a.

Example: [GC-916](GC-916) Changelog automatic generation
